          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <label className="flex flex-col gap-1.5 text-sm">
              ...
              <input
                ...
                placeholder="finance@novapay.demo"
            ...
            <button
              type="submit"
              className="mt-1 flex h-11 items-center justify-center gap-2 rounded-lg bg-teal-600 px-5 text-sm font-semibold text-white transition-colors hover:bg-teal-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2"
            >
              Sign in
            </button>
          </form>

          <p className="mt-6 rounded-lg bg-slate-100 px-4 py-3 text-xs text-slate-500">
            Demo credentials — <span className="font-mono">{DEMO_EMAIL}</span> / <span className="font-mono">{DEMO_PASSWORD}</span>
          </p>
        </div>
      </div>
    </div>
