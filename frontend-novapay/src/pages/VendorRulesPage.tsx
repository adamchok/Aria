...
const FIELD_COLORS: Record<string, string> = {
  ...
  payee: 'bg-teal-50 text-teal-700 ring-teal-200',
    ...
    <tr className="bg-teal-50/50">
      ...
      <td className="px-5 py-3">
        <input
          ...
          className="w-full rounded-md border border-teal-400 px-2.5 py-1.5 text-sm text-slate-900 focus:border-teal-500 focus:outline-none focus:ring-2 focus:ring-teal-500/20"
      ...
      <td className="px-5 py-3">
        <input
          ...
          className="w-full rounded-md border border-slate-200 px-2.5 py-1.5 text-sm text-slate-700 placeholder:text-slate-400 focus:border-teal-500 focus:outline-none focus:ring-2 focus:ring-teal-500/20"
      ...
      <td className="px-5 py-3">
        <div className="flex items-center justify-end gap-2">
          <button
            ...
            className="inline-flex items-center gap-1 rounded-md bg-teal-600 px-2.5 py-1.5 text-xs font-semibold text-white hover:bg-teal-700 disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
            aria-label="Save"
          >
            <CheckIcon /> Save
          </button>
          <button
            onClick={onCancel}
            className="inline-flex items-center gap-1 rounded-md px-2.5 py-1.5 text-xs font-medium text-slate-600 hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
            aria-label="Cancel"
          >
            <XIcon /> Cancel
          </button>
    ...
    return (
      <div className="flex items-center justify-end gap-2">
        ...
        <button
          ...
          className="rounded-md px-2.5 py-1 text-xs font-medium text-slate-600 hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
        >
          Cancel
        </button>
      </div>
    ...
    <tr className="transition-colors hover:bg-slate-50">
      ...
      <td className="px-5 py-4">
        <div className="flex items-center justify-end gap-2">
          <button
            onClick={onEdit}
            className="inline-flex items-center gap-1 rounded-md px-2.5 py-1.5 text-xs font-medium text-slate-600 hover:bg-slate-100 hover:text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            ...
            {rulesQuery.data && (
              <span className="ml-2 inline-flex items-center rounded-full bg-teal-50 px-2 py-0.5 text-xs font-medium text-teal-700 ring-1 ring-teal-200">
      ...
      <div className="flex items-start gap-3 rounded-xl border border-teal-100 bg-teal-50 px-4 py-3">
        <span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-teal-100 text-teal-600">
          <BrainIcon />
        </span>
        <div>
          <p className="text-sm font-medium text-teal-900">How ARIA learns</p>
